...
I decided to take a course on Udemy to get stronger on my React skills. This project is an application for a restaurant that allows users to place online orders.
